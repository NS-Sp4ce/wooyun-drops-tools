    ...
    <div class="layui-container">
        <div class="layui-col-xs6 layui-col-md12">
            <div class="layui-field-title">
                <h1><a href="http://<?php echo $_SERVER['SERVER_ADDR'] ;?>">乌云知识库</a></h1>
        ...
        if (mysql_num_rows($$drops_result2222)>0) {
            echo ' 
                ...
                <thead>
        		 ...
        		 echo '<td> <a href="http://'.$_SERVER["SERVER_ADDR"].$row223['link'].'" class="layui-btn layui-btn-normal" target="_blank">查看</a></td>'. PHP_EOL;
                 echo "</tr>";
                }
                echo '</tbody>';
                echo '</table>';
            ...
            if (mysql_num_rows($drops_random)>0) {
                echo ' 
                    ...
                    <thead>
                     ...
                     echo '<td> <a href="http://'.$_SERVER["SERVER_ADDR"].$row223333['link'].'" class="layui-btn layui-btn-normal" target="_blank">查看</a></td>'. PHP_EOL;
                     echo "</tr>";
                    }
            echo '</tbody>';
            echo '</table>';
